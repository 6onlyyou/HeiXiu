 ...
 * Author: fushuaige
 */
public class FansAdapter extends BaseQuickAdapter<DynamicEntity> {

    public FansAdapter(int layoutResId, List<DynamicEntity> data) {
        super(layoutResId, data);
    }

    public FansAdapter(List<DynamicEntity> data) {
        super(data);
    }

    public FansAdapter(View contentView, List<DynamicEntity> data) {
